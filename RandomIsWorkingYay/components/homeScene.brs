...
'Here are the randomizers for the questions, there are changes in ONHiddenStartButtonPressed, TriviaQuestion, and TorF functions nigguh
sub randomindexmcq()
