...
sub displayXorY()
    ...
    if m.count MOD 2 = 0 then
        for i = 0 to m.x.Count() - 1
            if m.x[i].translation[0] = m.cursor.translation[0] and m.x[i].translation[1] = m.cursor.translation[1] and appear=true then
                return' if the x is already visible, do nothing
            else if m.x[i].translation[0] = m.cursor.translation[0] and m.x[i].translation[1] = m.cursor.translation[1] then
                m.x[i].visible= true
                appear = true
            end if
        end for
        ...
        for i = 0 to m.o.Count() - 1
            if m.o[i].translation[0] = m.cursor.translation[0] and m.o[i].translation[1] = m.cursor.translation[1] and appear= true then
                return ' if the o is already visible, do nothing
            else if m.o[i].translation[0] = m.cursor.translation[0] and m.o[i].translation[1] = m.cursor.translation[1] then
                m.o[i].visible = true
                appear = true
            end if
        end for
